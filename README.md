...
I'm a Business Data Analytics student at COMSATS University Islamabad, building hands-on experience across analytics, machine learning, and finance. I work with SQL, Python, and Excel to turn raw data into clear, usable insight — and I'm currently narrowing my focus toward fintech.

Currently interning as an **AI-Powered Data Analysis Intern** at Excelerate (remote).

### 📊 Projects I've Worked On

- **Bank Customer Churn Analysis** — Excel-based analysis identifying why customers leave
- **Netflix SQL Business Insights** — business questions answered with SQL in pgAdmin
- **Email/SMS Spam Detection** — TF-IDF classifier comparing multiple ML models
- **Cohort Participation Analysis** — learner engagement report for a data bootcamp
- **EI & Academic Achievement Research** — Jupyter notebook research project

### 🛠️ Toolkit

`Excel` · `SQL` · `pgAdmin` · `Python` · `pandas` · `matplotlib` · `Machine Learning`
